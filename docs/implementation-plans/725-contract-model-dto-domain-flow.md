...
| 1.1, the order plan types | #734 | issue #733; `GenORDER.Lib/Scripts/OrderPlanTypes.fsx`: the types block for `Types.fs` after `OrderContext` and five tests for `TypeTests`; migration to source by the maintainer |
