# ADR-0002: MCP Server Architecture
...
| `Informedica.Utils.Lib` | Utility functions; not a domain service (its IO half is being split out, see [ADR-0001](0001-system-architecture.md)) |
