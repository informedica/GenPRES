...
These equations are sufficient to represent all quantitative dose, rate, volume, and concentration relations generated by GenORDER. See [GenORDER Appendix D.1: Equations Table](genorder-operational-rules-to-orders.md#appendix-d1-equations-table).
...
See [GenORDER Appendix B.3: Libraries](genorder-operational-rules-to-orders.md#appendix-b3-genorder-libraries) for the complete library architecture.
...
| Complete Equation Table | [GenORDER Appendix D.1](genorder-operational-rules-to-orders.md#appendix-d1-equations-table) |
| Variable Definitions | [GenORDER Appendix C.2](genorder-operational-rules-to-orders.md#appendix-c2-order-model-table) |
