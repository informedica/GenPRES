...
| [Testing Workflows](testing-workflows.md) | Reproducible testing procedures for QA: no-patient-context testing, manual and URL-based patient entry, unit conversion, emergency list, neonate scenarios, language switching, the demo launch sequence, enrolment, signing, and the SQLite session store |
