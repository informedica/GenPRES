    ...
    module NormalValues =
        ...
        let gcs =
            [
                ...
                5 * 12,
                [
                    "Eye Opening", [ (4, "spontaan"); (3, "bij geluid"); (2, "bij pijn"); (1, "geen"); (0, "zwelling of verband") ]
                    "Motor Response", [ (6, "normale spontane bewegingen"); (5, "lokaliseert bij pijn"); (4, "trekt terug bij pijn"); (3, "flexie bij pijn"); (2, "extensie bij pijn"); (1, "geen reactie op pijn") ]
                    "Verbal Response", [ (5, "alert, brabbelt, conform leeftijd"); (4, "minder, geirriteerd huilen"); (3, "huilt bij pijn"); (2, "kreunt bij pijn"); (1, "geen reactie op pijn"); (0, "tube") ]
                ]
                // Adult
                19 * 12,
                [
