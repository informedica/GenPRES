...
module EmergencyTreatment =
    ...
    let getTableData age wght joules medicationDefs =
        [ 
            [ "reanimatie"; "tube maat"; tube age; ""; "4 + leeftijd / 4" ]
            [ "reanimatie"; "tube lengte oraal"; oral age; ""; "12 + leeftijd / 2" ]
            [ "reanimatie"; "tube lengte nasaal"; nasal age; ""; "15 + leeftijd / 2" ]
            [ "reanimatie"; "epinephrine iv/io"; epiIv wght |> fst; epiIv wght |> snd; "0,01 mg/kg" ]
            [ "reanimatie"; "vaatvulling"; fluid wght |> fst; fluid wght |> snd; "20 ml/kg" ]
            [ "reanimatie"; "defibrillatie"; defib joules wght; ""; "4 Joule/kg" ]
            [ "reanimatie"; "cardioversie"; cardio joules wght; ""; "2 Joule/kg" ]
