...
module classesProps =
  ...
  module button =
    ...
    type classes =
      ...
      static member inline textSuccess(className: string) : IReactProperty = unbox ("classes.textSuccess", className)
      /// Styles applied to the root element if `variant="text"` and `color="error"`.
      static member inline textError(className: string) : IReactProperty = unbox ("classes.textError", className)
      /// Styles applied to the root element if `variant="text"` and `color="info"`.
      static member inline textInfo(className: string) : IReactProperty = unbox ("classes.textInfo", className)
      /// Styles applied to the root element if `variant="text"` and `color="warning"`.
      static member inline textWarning(className: string) : IReactProperty = unbox ("classes.textWarning", className)
      /// Styles applied to the root element if `variant="outlined"`.
      static member inline outlined(className: string) : IReactProperty = unbox ("classes.outlined", className)
      ...
      static member inline containedSuccess(className: string) : IReactProperty = unbox ("classes.containedSuccess", className)
      /// Styles applied to the root element if `variant="contained"` and `color="info"`.
      static member inline containedInfo(className: string) : IReactProperty = unbox ("classes.containedInfo", className)
      /// Styles applied to the root element if `variant="contained"` and `color="error"`.
      static member inline containedError(className: string) : IReactProperty = unbox ("classes.containedError", className)
      /// Styles applied to the root element if `variant="contained"` and `color="warning"`.
      static member inline containedWarning(className: string) : IReactProperty = unbox ("classes.containedWarning", className)
  ...
  module chip =
    ...
    type classes =
      ...
      /// Styles applied to the deleteIcon element if `color="primary"` and `variant="filled"`.
      static member inline deleteIconFilledColorPrimary(className: string) : IReactProperty = unbox ("classes.deleteIconFilledColorPrimary", className)
      /// Styles applied to the deleteIcon element if `color="secondary"` and `variant="filled"`.
      static member inline deleteIconFilledColorSecondary(className: string) : IReactProperty = unbox ("classes.deleteIconFilledColorSecondary", className)
      /// State class applied to the root element if keyboard focused.
      static member inline focusVisible(className: string) : IReactProperty = unbox ("classes.focusVisible", className)
