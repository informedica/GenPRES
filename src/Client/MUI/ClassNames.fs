...
type [<Erase>] bottomNavigation =

  /// Styles applied to the root element.
  static member inline root : string = ".MuiBottomNavigation-root"


type [<Erase>] bottomNavigationAction =
...
type [<Erase>] listItemSecondaryAction =
...
type [<Erase>] timelineOppositeContent =
