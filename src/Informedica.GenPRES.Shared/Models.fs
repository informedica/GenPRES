...
module Models =
    ...
    module OrderContext =
        ...
        /// domain's `PlanContext.nutritionCategory`; the agreement test keeps them equal.
        ...
        /// display copy of the domain's `PlanContext.contribution`; the agreement test keeps
        /// them equal.
    ...
    module OrderPlan =
        ...
        /// `OrderPlan.nutritionContexts`; the agreement test keeps them equal.
        ...
        /// agreement test keeps them equal.
        ...
        /// display copy of the domain's `OrderPlan.filtered`; the agreement test keeps them
        /// equal.
        ...
        /// the agreement test keeps them equal.
